...
from math import pi
from bokeh.palettes import Pastel1, Category10

# Para la dirección del HTML
from os.path import dirname, join

desc0 = Div(text=open(join(dirname(__file__), "TituloRAEE1.html")).read(), sizing_mode="stretch_width")
...
csv_profile_path = r"../../../CSVs/Unificar Abr-Jun25/Curso residuos/MAATE-UTPL_RAEE3_2025_1_student_profile_info_2025-05-19-2250.csv"
csv_grade_path = r"../../../CSVs/Unificar Abr-Jun25/Curso residuos/MAATE-UTPL_RAEE3_2025_1_grade_report_2025-05-19-2235.csv"
...
eval_columns = ["Test 01", "Test 02", "Test 03", "Test 04", "Test 05", "Test 06", "Test Avg"]
...
data_filtrada = data[data["Test Avg"] < puntaje_minimo]
data_filtrada_apro = data[data["Test Avg"] >= puntaje_minimo]
...
colores0 = Category10[max(3, len(conteo_genero_0))]  # Asegura mínimo 3 colores
...
colores = Pastel1[max(3, len(conteo_genero))]  # Lo mismo aquí
...
p_general.add_tools(hover_femenino, hover_masculino)
...
colores_pastel = ["#5A7937", "#E5989B"]  # Verde (Aprobado) - Marrón (Reprobado)
graficos_pastel = []
