...
ruta_salida_txt = r"C:\Users\nahom\OneDrive - Universidad Técnica Particular de Loja - UTPL\Curso Documentos Accesibles\CSV\analisis-codigo\datos-evaluacion-sem4.txt"

# Leer el archivo CSV
df = pd.read_csv(ruta_csv, delimiter=',')

# Seleccionar la columna "EvalSemanal 0n"
columna_eval = df["EvalSemanal 04"]
...
with open(ruta_salida_txt, "w") as file:
    file.write("Frecuencia de valores en la columna 'EvalSemanal 04':\n")
...
plt.title("Frecuencia de valores - EvalSemanal 04")
plt.xlabel("Valores")
plt.ylabel("Frecuencia")
plt.xticks(rotation=45)
plt.tight_layout()
ruta_grafico_barras = os.path.join(ruta_base, "grafico_barras_eval_semana04.jpg")
...
plt.title("Distribución porcentual - EvalSemanal 04")
plt.ylabel("")  # Quitar etiqueta del eje y
ruta_grafico_pastel = os.path.join(ruta_base, "grafico_pastel_eval_semana04.jpg")
